...
//     // Phone regex: allows + followed by digits, or just digits, with optional spaces, dashes, or parentheses
//     const phoneRegex = /^\+?\d{1,4}?[-.\s]?\(?\d{1,3}?\)?[-.\s]?\d{1,4}[-.\s]?\d{1,4}$/;
//     // Username regex: alphanumeric with optional underscores or hyphens, 3-30 characters
...
//         <div>
//           <h1 className="text-3xl font-bold text-gray-900 text-center">Nstayz</h1>
//         </div>
...
//                 className="w-full pb-2 bg-transparent border-b border-gray-400 text-gray-900 placeholder-gray-500 focus:outline-none focus:border-blue-500"
...
//               loading ? "bg-gray-500 cursor-not-allowed" : "bg-[#2563EB] hover:bg-[#1E40AF]"
