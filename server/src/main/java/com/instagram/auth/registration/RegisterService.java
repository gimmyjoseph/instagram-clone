...
//         public Response updatePrivacy(ObjectId id,boolean isPrivate)
//         {
//             if (id == null) {
//                 return new Response(400, "User ID is required", false);
//             }
//         Register user=registerRepository.findById(id).orElse(null);
//          if (user == null) {
...
//         return new Response(200, "Privacy updated successfully", true, user);
...
// }
public Response getListChat(){

            List<Register> allList=registerRepository.findAll();
            List<ForChat> newList=new ArrayList();

            for(Register list:allList){
                ForChat chat=new ForChat(list.getUserId(),list.getUserName());
                newList.add(chat);
                
            }
            return new Response(200,"all list sent",true,newList);
        }
